        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <!-- 属性 -->
              <dl v-for="Seclect in spuSaleAttrList" :key="Seclect.id">
                <dt class="title">{{ Seclect.saleAttrName }}</dt>

                <!-- 属性值 -->
                <dd
                  changepirce="0"
                  :class="{ active: spuSaleAttrValue.isChecked == 1 }"
                  v-for="spuSaleAttrValue in Seclect.spuSaleAttrValueList"
                  :key="spuSaleAttrValue.id"
                  @click="
                    changeActive(spuSaleAttrValue, Seclect.spuSaleAttrValueList)
                  "
                >
            ...
            <div class="cartWrap">
              <div class="controls">
                ...
                <a href="javascript:" class="mins" @click="delectskuNum">-</a>
              </div>
              <div class="add">
                <a href="javascript:" @click="addShoper">加入购物车</a>
              </div>
            </div>
          </div>
        </div>
  ...
  methods: {
    ...
    async addShoper() {
      ...
      try {
        ...
        // 进行路由跳转
        // 在路由跳转的时候传递参数
        // 产品信息的数据【比较复杂】，通过会话存储（不持久话，会话结束数据结束）
